...
namespace DungeonKIT
{
    public class PlayerController : MonoBehaviour
    {
        ...
        PlayerCombatManager playerCombat;
        ...
        private void Start()
        {
            ...
            playerCombat = PlayerCombatManager.Instance;
            playerCombat.Init();
        ...
        void Inputs()
        {
            if (InputManager.Pause) //If player press pause button
            {
                ...
                UIGameManager.Instance.Pause(); //Show UI pause screen
            }

            //if pause disable and game
            if (!UIGameManager.Instance.isPause && GameManager.Instance.isGame)
            {
