...
public class Shotgun : Gun
{
    ...
    protected override void Fire()
    {
        ...
        {
            GameObject bullet = AssetServer.Instance.GetGameObjectFromPool(bulletname,true);
        ...
        GameObject shell = AssetServer.Instance.GetGameObjectFromPool(shellname, false);
